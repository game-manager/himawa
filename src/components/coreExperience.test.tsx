...
describe('HIMAWA core experience', () => {
  ...
  it('supports both uploaded photos and part-based avatar editing', () => {
    ...
    const generatedAvatarHtml = renderToStaticMarkup(<Avatar config={DEFAULT_AVATAR} />)
    expect(generatedAvatarHtml).toContain('avatar__generated-hair')
    expect(generatedAvatarHtml).toContain('avatar/generated/hair/soft.png')
    expect(generatedAvatarHtml).toContain('avatar/generated/mouth/smile.png')
    expect(generatedAvatarHtml).toContain('avatar/generated/outfit/tomato.png')
    ...
    expect(editorHtml).toContain('右へスクロール')
    expect(editorHtml).toContain('avatar/generated/accessory/cap.png')
